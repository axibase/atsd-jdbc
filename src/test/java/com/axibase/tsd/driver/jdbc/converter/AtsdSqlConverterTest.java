...
public class AtsdSqlConverterTest {
    ...
    public void testConverUpdateToSeries() throws SQLException {
        ...
        commands = converter.convertToCommands(sql);
        Assert.assertEquals(1, commands.size());
        expected = "series e:sensor-1 ms:123456789 t:unit=\"celcius\" m:jvm_memory_free=24.5";
        Assert.assertEquals(expected, commands.get(0));
    ...
    @Test
    public void testConvertInsertToEntityAndMetricCommands() throws SQLException {
    ...
    @Test
    public void testConvertInsertWithInvalidEntityInterpolate() throws SQLException {
        expectedException.expect(IllegalArgumentException.class);
        expectedException.expectMessage("Invalid entity interpolation: test");
    ...
    @Test
    public void testConvertUpdateToEntityAndMetricCommands() throws SQLException {
