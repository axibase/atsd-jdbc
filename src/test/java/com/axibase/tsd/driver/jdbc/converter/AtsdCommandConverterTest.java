...
public class AtsdCommandConverterTest {
    ...
    public void testConvertInsertToSeries() throws SqlParseException {
        ...
        String command = AtsdCommandConverter.convertSqlToCommand(sql);
        ...
        command = AtsdCommandConverter.convertSqlToCommand(sql, Collections.<Object>singletonList(24.5));
        Assert.assertEquals(expected, command);
        ...
        command = AtsdCommandConverter.convertBatchToCommands(sql, valueBatch);
        ...
        command = AtsdCommandConverter.convertSqlToCommand(sql);
